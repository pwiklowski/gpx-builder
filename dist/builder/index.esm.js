...
class Esk8palPoint extends Point {
  constructor(lat, lon, options = {}) {
    ...
    const data = _objectSpread$a({}, voltage ? {
    ...
    this.extensions = _objectSpread$a({}, this.extensions, {}, Object.keys(data).length > 0 ? {
      [trackPointExtension]: data
    } : {});
  }
...
class Esk8palBuilder extends BaseBuilder {
  constructor() {
    ...
    this.data = _objectSpread$b({}, this.data, {
      attributes: _objectSpread$b({}, this.data.attributes)
    });
  }

}

_defineProperty(Esk8palBuilder, "MODELS", _objectSpread$b({}, BaseBuilder.MODELS, {
  Point: Esk8palPoint
}));

export { BaseBuilder, Esk8palBuilder, GarminBuilder };
